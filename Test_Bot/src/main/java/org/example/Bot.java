...
public class Bot extends TelegramLongPollingBot {
    ...
    public String getBotUsername() {
        return "https://t.me/testtbtt43_bot";
    }
    ...
    private static ArrayList<KeyboardRow> getKeyboardRows(Class someClass) {
        ...
        for (int rowIndex = 0; rowIndex < rowCount; rowIndex++) {
            KeyboardRow row = getKeyboardButtons(columCount, rowIndex, commands);
            keyboardRows.add(row);
        }
        return keyboardRows;
    }

    private static KeyboardRow getKeyboardButtons(int columCount, int rowIndex, ArrayList<AppBotCommand> commands) {
